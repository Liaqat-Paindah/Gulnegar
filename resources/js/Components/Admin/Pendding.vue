<template>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr v-for="Product in Products.data" key="Product.id">
                            ...
                            <th><router-link :to="{name: 'pendding_edit', params:{id:Product.id} }" class="btn btn-sm btn-primary">Approve</router-link></th>
                        </tr>
                    </tbody>
                </table>
                <div class="row">
        ...
        components:
  {
    Bootstrap4Pagination:Bootstrap4Pagination
         ...
         fetchdata(page=1)
         {
          axios.get('/api/pendding?page='+page).then(res => {
