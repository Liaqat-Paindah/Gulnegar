<template>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-5">
              ...
              <ul class="list-group margin-bottom-25 sidebar-menu">
                <h4>Top Models</h4>
                <li v-for="Model in TopModels" :key="Model.id" class="list-group-item clearfix dropdown">
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12" v-for="Product in Products" key="Product.id">
                <div class="product-item">
                  ...
                  <h3><router-link :to="{ name: 'ShopItem', params: { id: Product.id } }"> {{Product.Model_Name}}</router-link></h3>
  ...
  import axios from 'axios';
      export default
      {
         ...
         fetchdata()
         {
          axios.get('/api/model/'+this.Model_ID).then(res => {
